...
@section('title', 'Rupani Foundation - Partners')
                ...
                <div class="col-sm-12">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading well well-lg">
                            <h3 class="panel-title pull-left">Partners Table</h3>
                            <a href="{{url('addPartner')}}" class="btn btn-info pull-right">Add a Partner</a>
                        </div>
                        <div class="panel-body">

                            <table class="table table-bordered table-striped" id="{{ count($partners) > 0 ? 'datatable' : '' }}">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="datatable">
                                        ...
                                        <td class="actions">
                                            <a href="{{('updatePartner/'.$item->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                            ...
                                            <div class="modal-dialog" style="width:55%;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="deletePartner/{{ $item->id }}" type="button" class="btn btn-danger waves-effect waves-light">Confirm</a>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
