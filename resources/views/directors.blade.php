...
@section('title', 'Rupani Foundation - Board of Directors')
...
<div class="content-page">
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="pull-left page-title">Board of Directors</h4>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading well well-lg">
                            <h3 class="panel-title pull-left">Board of Directors Table</h3>
                            <a href="addDirector" class="btn btn-info pull-right">Add a Director</a>
                        </div>
                        <div class="panel-body">

                            <table class="table table-bordered table-striped" id="{{ count($directors) > 0 ? 'datatable' : '' }}">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="datatable">
                                        ...
                                        <td class="actions">
                                            <a href="{{('updateDirector/'.$item->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                            ...
                                            <div class="modal-dialog" style="width:55%;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="deleteDirector/{{ $item->id }}" type="button" class="btn btn-danger waves-effect waves-light">Confirm</a>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
