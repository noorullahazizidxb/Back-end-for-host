...
@section('title', 'Add Management Team Member')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Add a Team Member</li>
                    </ol>
                </div>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Add a Team Member</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST" action="addTeamMember" novalidate="novalidate" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="cnaslider-textme" class="control-label col-lg-2">Name</label>
                                        <div class="col-lg-10">
                                            <input class=" form-control" name="name" type="text" placeholder="Enter the Name of the Team Member" required="" aria-required="true" value="{{ old('name') }}">
                                            @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" name="position" type="text" placeholder="Enter the Position of the Team Member" required="" aria-required="true" value="{{ old('position') }}">
                                            @error('position')
                                            <label id="slider-text-error" class="error" for="slider-text">
                                                {{ $message }}
                                            </label>
