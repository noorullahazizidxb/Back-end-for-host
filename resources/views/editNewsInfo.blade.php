                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Edit a News Info</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST"
                                    action="{{url('updateNewsInfo/' . $newsInfo->id)}}" novalidate="novalidate"
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-5 col-md-offset-1">
                                            ...
                                            <select class="form-control" id="start_month" name="start_month">
                                                ...
                                                @foreach ($months as $monthName)
                                                    <option value="{{ $monthName }}" {{ $newsInfo->start_month === $monthName ? 'selected' : '' }}>{{ $monthName }}</option>
                                                @endforeach
                                            </select>
                                            @error('start_month')
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <select class="form-control" id="end_month" name="end_month">
                                                ...
                                                @foreach ($months as $monthName)
                                                    <option value="{{ $monthName }}" {{ $newsInfo->end_month === $monthName ? 'selected' : '' }}>{{ $monthName }}</option>
                                                @endforeach
                                            </select>
                                            @error('end_month')
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-5 col-md-offset-1">
                                            ...
                                            <select class="form-control" id="year" name="year">
                                                ...
                                                @for ($year = $currentYear; $year >= 2000; $year--)
                                                    <option value="{{ $year }}" {{ $newsInfo->year == $year ? 'selected' : '' }}>{{ $year }}</option>
                                                @endfor
                                            </select>
                                            @error('year')
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <input class=" form-control" name="image_alt" type="text"
                                                placeholder="Enter the alternative text for the Image" required="" value="{{$newsInfo->image_alt}}" 
