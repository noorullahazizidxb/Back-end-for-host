...
@section('title', 'Edit Reports and Data')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Edit a Reports and Data</li>
                    </ol>
                </div>
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Edit a Reports and Data</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST"
                                    action="{{url('updateReport/' . $report->id)}}" novalidate="novalidate"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-5 col-lg-offset-1">
                                            ...
                                            <input class=" form-control" name="title" type="text"
                                                ...
                                                aria-required="true" value="{{ (old('title') != $report->title && old('title') === null) ? $report->title : old('title') }}">
                                            @error('title')
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <input class=" form-control" name="image_alt" type="text"
                                                ...
                                                aria-required="true" value="{{ (old('image_alt') != $report->image_alt && old('image_alt') === null) ? $report->image_alt : old('image_alt') }}">
                                            @error('image_alt')
