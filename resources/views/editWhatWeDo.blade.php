...
@section('title', 'Edit What We Do Content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">Edit a Record</li>
                    </ol>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Edit a Content</h3>
                        </div>
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal tasi-form" id="commentForm" method="POST"
                                    action="{{ url('updateWhatWeDo/'. $whatWeDo->id)}} " novalidate="novalidate"
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-1">
                                            ...
                                            <input class=" form-control" name="title" type="text"
                                                ...
                                                aria-required="true" value="{{ (old('title') != $whatWeDo->title && old('title') === null) ? $whatWeDo->title : old('title') }}">
                                            @error('title')
                                    ...
                                    <div class="form-group col-lg-offset-1">
                                        <div class="col-lg-5 col-lg-offset-1">
                                            ...
                                            <select class="select2" name="category_id"
                                                ...
                                                <option value="{{ $item->id }}" {{ $item->id == $whatWeDo->category_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('category_id')
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-1">
                                            ...
                                            <textarea class=" form-control" name="starter_text" type="text"
                                                ...
                                                aria-required="true" rows="5">{{ (old('starter_text') != $whatWeDo->starter_text && old('starter_text') === null) ? $whatWeDo->starter_text : old('starter_text') }}</textarea>
                                            @error('starter_text')
                                            <label id="slider-text-error" class="error" for="slider-text">
                                                {{ $message }}
                                            </label>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-lg-offset-1">
                                            ...
                                            <textarea name="content" class="summernote">{{ (old('content') != $whatWeDo->content && old('content') === null) ? $whatWeDo->content : old('content') }}</textarea>
