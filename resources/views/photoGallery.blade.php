...
@section('title', 'Rupani Foundation - Photo Gallery')
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="panel panel-border panel-inverse">
                        <div class="panel-heading well well-lg">
                            <h3 class="panel-title pull-left">Photo Gallery Table</h3>
                            <a href="{{ url('addGalleryPhoto') }}" class="btn btn-info pull-right">Add a Photo Record</a>
                        </div>
                        <div class="panel-body">

                            <table class="table table-bordered table-striped" id="{{ count($photoGallery) > 0 ? 'datatable' : '' }}">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Description</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="datatable">
                                        <td>{{ $item->id }}</td>
                                        <td class="text-wrap">{{ Str::limit($item->description, 80, '...') }}</td>
                                        <td>{{ $item->image_alt }}</td>
                                        <td>
                                            <img src="{{ $item->image }}" width="100%" height="50" />
                                        </td>
                                        <td class="actions">
                                            <a href="{{('updateGalleryPhoto/'.$item->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                                            ...
                                            <div class="modal-dialog" style="width:55%;">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="deleteGalleryPhoto/{{ $item->id }}" type="button" class="btn btn-danger waves-effect waves-light">Confirm</a>
                                                    </div>
                                                </div><!-- /.modal-content -->
                                            </div><!-- /.modal-dialog -->
                                        </div><!-- /.modal -->
